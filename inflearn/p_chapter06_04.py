...
# Fatures 동시성
# 비동기 작업 실행
# 지연시간(Block) CPU 및 리소스 낭비 방지 -> (File)Network I/O관련 작업
# -> 동시성 활용 권장
...
import os
import time
from concurrent import futures # import threading, multiprocessing
...
def main():
    ...
    # 결과 건수
    # ProcessPoolExcuotor
    with futures.ThreadPoolExecutor() as excutor: # 동시에 연산
        # map -> 작업 순서 유지, 즉시 실행
